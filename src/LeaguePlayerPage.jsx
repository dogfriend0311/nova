...
const SavantCard = ({ player }) => {
  ...
  return (
    <div className="savant-card neon-card">
      ...
      {batting.length > 0 && (
        <>
          <div className="sv-section-label">âš¾ Batting</div>
      ...
      {pitching.length > 0 && (
        <>
          <div className="sv-section-label">âš¡ Pitching</div>
          <div className="sv-bars">
...
const LeaguePlayerPage = ({ player, onBack, leaguePrefix: leaguePrefix_prop }) => {
  ...
  const leaguePrefix = leaguePrefix_prop || 'nabb';
    ...
    <div className="league-player-page">
      ...
      <div className="player-container">
        ...
        <div className="player-stats">
          ...
          />
          <StatSection
            title="ðŸ“Š Advanced Hitting Stats"
            color="magenta"
          ...
          />
          <StatSection
            title="âš¡ Season Pitching Stats"
            color="cyan"
          ...
          />
          <StatSection
            title="ðŸ“ˆ Advanced Pitching Stats"
            color="magenta"
